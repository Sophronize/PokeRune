...
import com.github.Sophronize.sound.Sound;
...
public class Triggers {
    ...
    private void sendHighlightedMessageForColLogNotifSetting() {
        String highlightedMessage = new ChatMessageBuilder()
                ...
                .append("Please enable \"Collection log - New addition notification\" in your game settings for PokeRune to know when to announce it! (The chat message one, pop-up doesn't matter)")
                .build();
    ...
    public void onConfigChanged(ConfigChanged event) {
        if (PokeRuneConfig.GROUP.equals(event.getGroup())) {
